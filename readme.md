...
- В заголовках запроса клиент отправляет дополнительные опции. [MDN](https://developer.mozilla.org/ru/docs/Web/HTTP/%D0%97%D0%B0%D0%B3%D0%BE%D0%BB%D0%BE%D0%B2%D0%BA%D0%B8)
- Варианты типов контента - это MIME-типы (Multipurpose Internet Mail Extensions). 
[MDN](https://developer.mozilla.org/ru/docs/Web/HTTP/Basics_of_HTTP/MIME_types)
